...
- `04_order_effects/` through `11_profile_external_comparisons/` each contain their rendered report plus script-specific `csv/` and `plots/` outputs.
- `13_results/` contains the final results report.
...
- `07_q17_ai_use/csv/Q17_Participant_AI_Use_Index.csv`
- `09_art_vs_all_factors_items/csv/ART_Factor_Merged.csv`
...
- `.\render_numbered_qmds.ps1 04_order_effects.qmd` renders a specific step into `04_order_effects/`.
...
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 04_order_effects.qmd --output-dir 04_order_effects
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 05_beliefs_item_analysis.qmd --output-dir 05_beliefs_item_analysis
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 06_interesting_findings.qmd --output-dir 06_interesting_findings
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 07_q17_ai_use.qmd --output-dir 07_q17_ai_use
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 08_ai_beliefs_items.qmd --output-dir 08_ai_beliefs_items
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 09_art_vs_all_factors_items.qmd --output-dir 09_art_vs_all_factors_items
...
XDG_CACHE_HOME=/tmp/quarto-cache ~/.local/bin/quarto render 13_results.qmd --output-dir 13_results
```
